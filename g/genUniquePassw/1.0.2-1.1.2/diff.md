# Comparing `tmp/genUniquePassw-1.0.2.tar.gz` & `tmp/genUniquePassw-1.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "genUniquePassw-1.0.2.tar", last modified: Tue Jul 18 18:05:45 2023, max compression
+gzip compressed data, was "genUniquePassw-1.1.2.tar", last modified: Wed Jul 19 03:13:14 2023, max compression
```

## Comparing `genUniquePassw-1.0.2.tar` & `genUniquePassw-1.1.2.tar`

### file list

```diff
@@ -1,12 +1,12 @@
-drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-18 18:05:45.519305 genUniquePassw-1.0.2/
--rw-rw-r--   0 user      (1000) user      (1000)      733 2023-07-18 18:05:45.519305 genUniquePassw-1.0.2/PKG-INFO
-drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-18 18:05:45.519305 genUniquePassw-1.0.2/genUniquePassw.egg-info/
--rw-rw-r--   0 user      (1000) user      (1000)      733 2023-07-18 18:05:45.000000 genUniquePassw-1.0.2/genUniquePassw.egg-info/PKG-INFO
--rw-rw-r--   0 user      (1000) user      (1000)      209 2023-07-18 18:05:45.000000 genUniquePassw-1.0.2/genUniquePassw.egg-info/SOURCES.txt
--rw-rw-r--   0 user      (1000) user      (1000)        1 2023-07-18 18:05:45.000000 genUniquePassw-1.0.2/genUniquePassw.egg-info/dependency_links.txt
--rw-rw-r--   0 user      (1000) user      (1000)        8 2023-07-18 18:05:45.000000 genUniquePassw-1.0.2/genUniquePassw.egg-info/top_level.txt
-drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-18 18:05:45.519305 genUniquePassw-1.0.2/package/
--rw-rw-r--   0 user      (1000) user      (1000)       17 2023-07-18 17:14:20.000000 genUniquePassw-1.0.2/package/__init__.py
--rw-rw-r--   0 user      (1000) user      (1000)     1280 2023-07-18 10:39:31.000000 genUniquePassw-1.0.2/package/generate_password.py
--rw-rw-r--   0 user      (1000) user      (1000)       38 2023-07-18 18:05:45.519305 genUniquePassw-1.0.2/setup.cfg
--rw-rw-r--   0 user      (1000) user      (1000)     1525 2023-07-18 18:05:36.000000 genUniquePassw-1.0.2/setup.py
...
### Comparing `genUniquePassw-1.0.2/PKG-INFO` & `genUniquePassw-1.1.2/PKG-INFO`
...
### Comparing `genUniquePassw-1.0.2/genUniquePassw.egg-info/PKG-INFO` & `genUniquePassw-1.1.2/genUniquePassw.egg-info/PKG-INFO`
...
### Comparing `genUniquePassw-1.0.2/package/generate_password.py` & `genUniquePassw-1.1.2/package/generate_password.py`

 * *Files identical despite different names*

### Comparing `genUniquePassw-1.0.2/setup.py` & `genUniquePassw-1.1.2/setup.py`
...
-    version='1.0.2',                # Replace with the version number of your package
