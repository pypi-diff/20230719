# Comparing `tmp/fastapi-serve-0.0.4.dev8.tar.gz` & `tmp/fastapi-serve-0.0.4.dev9.tar.gz`
...
### Comparing `fastapi-serve-0.0.4.dev8/LICENSE` & `fastapi-serve-0.0.4.dev9/LICENSE`
