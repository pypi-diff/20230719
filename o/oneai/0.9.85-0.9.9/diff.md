# Comparing `tmp/oneai-0.9.85.tar.gz` & `tmp/oneai-0.9.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "oneai-0.9.85.tar", last modified: Wed Jul 19 09:29:13 2023, max compression
+gzip compressed data, was "oneai-0.9.9.tar", last modified: Sun Jan 22 19:40:56 2023, max compression
```

## Comparing `oneai-0.9.85.tar` & `oneai-0.9.9.tar`

### file list

```diff
@@ -1,37 +1,29 @@
-drwxr-xr-x   0 michaelgur   (501) staff       (20)        0 2023-07-19 09:29:13.730528 oneai-0.9.85/
--rw-r--r--   0 michaelgur   (501) staff       (20)     1084 2022-07-27 08:48:35.000000 oneai-0.9.85/LICENSE
--rw-r--r--   0 michaelgur   (501) staff       (20)     9131 2023-07-19 09:29:13.730646 oneai-0.9.85/PKG-INFO
--rw-r--r--   0 michaelgur   (501) staff       (20)     8694 2023-04-02 13:51:49.000000 oneai-0.9.85/README.md
--rw-r--r--   0 michaelgur   (501) staff       (20)      104 2022-07-27 08:49:02.000000 oneai-0.9.85/pyproject.toml
--rw-r--r--   0 michaelgur   (501) staff       (20)      824 2023-07-19 09:29:13.731082 oneai-0.9.85/setup.cfg
-drwxr-xr-x   0 michaelgur   (501) staff       (20)        0 2023-07-19 09:29:13.714180 oneai-0.9.85/src/
-drwxr-xr-x   0 michaelgur   (501) staff       (20)        0 2023-07-19 09:29:13.724605 oneai-0.9.85/src/oneai/
--rw-r--r--   0 michaelgur   (501) staff       (20)     1437 2023-07-19 09:28:45.000000 oneai-0.9.85/src/oneai/__init__.py
-drwxr-xr-x   0 michaelgur   (501) staff       (20)        0 2023-07-19 09:29:13.727478 oneai-0.9.85/src/oneai/api/
--rw-r--r--   0 michaelgur   (501) staff       (20)      438 2022-12-18 06:49:48.000000 oneai-0.9.85/src/oneai/api/__init__.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     3568 2023-06-12 08:54:42.000000 oneai-0.9.85/src/oneai/api/clustering.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     3360 2023-05-29 09:44:44.000000 oneai-0.9.85/src/oneai/api/output.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     5004 2023-05-29 09:43:06.000000 oneai-0.9.85/src/oneai/api/pipeline.py
--rw-r--r--   0 michaelgur   (501) staff       (20)    14322 2023-06-20 11:39:50.000000 oneai-0.9.85/src/oneai/classes.py
--rw-r--r--   0 michaelgur   (501) staff       (20)    10151 2023-07-19 09:27:45.000000 oneai-0.9.85/src/oneai/clustering.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     2583 2022-09-22 14:06:15.000000 oneai-0.9.85/src/oneai/exceptions.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     1008 2022-12-29 11:56:46.000000 oneai-0.9.85/src/oneai/logger.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     3913 2023-05-29 10:14:02.000000 oneai-0.9.85/src/oneai/output.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     6996 2022-12-18 07:31:42.000000 oneai-0.9.85/src/oneai/parsing.py
--rw-r--r--   0 michaelgur   (501) staff       (20)    10037 2023-05-29 10:16:02.000000 oneai-0.9.85/src/oneai/pipeline.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     8320 2023-06-20 11:39:50.000000 oneai-0.9.85/src/oneai/process_scheduler.py
--rw-r--r--   0 michaelgur   (501) staff       (20)    19626 2023-07-17 11:22:29.000000 oneai-0.9.85/src/oneai/skills.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     1666 2023-04-10 16:16:55.000000 oneai-0.9.85/src/oneai/util.py
-drwxr-xr-x   0 michaelgur   (501) staff       (20)        0 2023-07-19 09:29:13.725989 oneai-0.9.85/src/oneai.egg-info/
--rwxrwxrwx   0 michaelgur   (501) staff       (20)     9131 2023-07-19 09:29:13.000000 oneai-0.9.85/src/oneai.egg-info/PKG-INFO
--rwxrwxrwx   0 michaelgur   (501) staff       (20)      684 2023-07-19 09:29:13.000000 oneai-0.9.85/src/oneai.egg-info/SOURCES.txt
--rwxrwxrwx   0 michaelgur   (501) staff       (20)        1 2023-07-19 09:29:13.000000 oneai-0.9.85/src/oneai.egg-info/dependency_links.txt
--rwxrwxrwx   0 michaelgur   (501) staff       (20)      192 2023-07-19 09:29:13.000000 oneai-0.9.85/src/oneai.egg-info/requires.txt
--rwxrwxrwx   0 michaelgur   (501) staff       (20)        6 2023-07-19 09:29:13.000000 oneai-0.9.85/src/oneai.egg-info/top_level.txt
-drwxr-xr-x   0 michaelgur   (501) staff       (20)        0 2023-07-19 09:29:13.730168 oneai-0.9.85/tests/
--rw-r--r--   0 michaelgur   (501) staff       (20)     2258 2023-05-16 07:53:45.000000 oneai-0.9.85/tests/test_clustering.py
--rw-r--r--   0 michaelgur   (501) staff       (20)      611 2023-04-02 12:45:22.000000 oneai-0.9.85/tests/test_errors.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     3105 2023-05-25 16:36:48.000000 oneai-0.9.85/tests/test_files.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     1232 2023-03-31 07:44:45.000000 oneai-0.9.85/tests/test_parsing.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     5599 2023-05-29 10:16:17.000000 oneai-0.9.85/tests/test_pipeline.py
--rw-r--r--   0 michaelgur   (501) staff       (20)     2419 2023-05-03 10:53:39.000000 oneai-0.9.85/tests/test_skill.py
...
### Comparing `oneai-0.9.85/LICENSE` & `oneai-0.9.9/LICENSE`

 * *Files identical despite different names*

### Comparing `oneai-0.9.85/PKG-INFO` & `oneai-0.9.9/PKG-INFO`
...
```diff
@@ -1,36 +1,26 @@
-Metadata-Version: 2.1 Name: oneai Version: 0.9.85 Summary: NLP as a Service
...
### Comparing `oneai-0.9.85/README.md` & `oneai-0.9.9/src/oneai.egg-info/PKG-INFO`
...
### Comparing `oneai-0.9.85/setup.cfg` & `oneai-0.9.9/setup.cfg`
...
### Comparing `oneai-0.9.85/src/oneai/__init__.py` & `oneai-0.9.9/src/oneai/__init__.py`
...
### Comparing `oneai-0.9.85/src/oneai/api/clustering.py` & `oneai-0.9.9/src/oneai/api/clustering.py`
...
### Comparing `oneai-0.9.85/src/oneai/api/output.py` & `oneai-0.9.9/src/oneai/api/output.py`
...
### Comparing `oneai-0.9.85/src/oneai/api/pipeline.py` & `oneai-0.9.9/src/oneai/api/pipeline.py`
...
### Comparing `oneai-0.9.85/src/oneai/classes.py` & `oneai-0.9.9/src/oneai/classes.py`
...
### Comparing `oneai-0.9.85/src/oneai/clustering.py` & `oneai-0.9.9/src/oneai/clustering.py`
...
### Comparing `oneai-0.9.85/src/oneai/exceptions.py` & `oneai-0.9.9/src/oneai/exceptions.py`

 * *Files identical despite different names*

### Comparing `oneai-0.9.85/src/oneai/logger.py` & `oneai-0.9.9/src/oneai/logger.py`

 * *Files identical despite different names*

### Comparing `oneai-0.9.85/src/oneai/parsing.py` & `oneai-0.9.9/src/oneai/parsing.py`

 * *Files identical despite different names*

### Comparing `oneai-0.9.85/src/oneai/pipeline.py` & `oneai-0.9.9/src/oneai/pipeline.py`
...
### Comparing `oneai-0.9.85/src/oneai/process_scheduler.py` & `oneai-0.9.9/src/oneai/process_scheduler.py`
...
### Comparing `oneai-0.9.85/src/oneai/skills.py` & `oneai-0.9.9/src/oneai/skills.py`
...
### Comparing `oneai-0.9.85/src/oneai/util.py` & `oneai-0.9.9/src/oneai/util.py`
