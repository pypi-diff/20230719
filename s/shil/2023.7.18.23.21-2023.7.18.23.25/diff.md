# Comparing `tmp/shil-2023.7.18.23.21.tar.gz` & `tmp/shil-2023.7.18.23.25.tar.gz`
...
+gzip compressed data, was "shil-2023.7.18.23.25.tar", last modified: Tue Jul 18 23:25:20 2023, max compression
```

## Comparing `shil-2023.7.18.23.21.tar` & `shil-2023.7.18.23.25.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 23:25:20.670591 shil-2023.7.18.23.25/
+-rw-r--r--   0 runner    (1001) docker     (123)     4970 2023-07-18 23:25:20.670591 shil-2023.7.18.23.25/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     4354 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/README.md
+-rw-r--r--   0 runner    (1001) docker     (123)     1158 2023-07-18 23:25:20.670591 shil-2023.7.18.23.25/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)      766 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 23:25:20.658591 shil-2023.7.18.23.25/src/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 23:25:20.670591 shil-2023.7.18.23.25/src/shil/
+-rw-r--r--   0 runner    (1001) docker     (123)      218 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      859 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/__main__.py
+-rw-r--r--   0 runner    (1001) docker     (123)       78 2023-07-18 23:25:16.000000 shil-2023.7.18.23.25/src/shil/_version.py
+-rw-r--r--   0 runner    (1001) docker     (123)       48 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/bin.py
+-rw-r--r--   0 runner    (1001) docker     (123)      210 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/console.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 23:25:20.670591 shil-2023.7.18.23.25/src/shil/models/
+-rw-r--r--   0 runner    (1001) docker     (123)     9259 2023-07-18 23:24:25.000000 shil-2023.7.18.23.25/src/shil/models/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      254 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/models/base.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 23:25:20.670591 shil-2023.7.18.23.25/src/shil/parser/
+-rw-r--r--   0 runner    (1001) docker     (123)      837 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/parser/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     5551 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/parser/grammar.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3264 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/parser/semantics.py
+-rw-r--r--   0 runner    (1001) docker     (123)      642 2023-07-18 23:23:45.000000 shil-2023.7.18.23.25/src/shil/util.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 23:25:20.670591 shil-2023.7.18.23.25/src/shil.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     4970 2023-07-18 23:25:20.000000 shil-2023.7.18.23.25/src/shil.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      470 2023-07-18 23:25:20.000000 shil-2023.7.18.23.25/src/shil.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-18 23:25:20.000000 shil-2023.7.18.23.25/src/shil.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-18 23:25:20.000000 shil-2023.7.18.23.25/src/shil.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (123)      170 2023-07-18 23:25:20.000000 shil-2023.7.18.23.25/src/shil.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        5 2023-07-18 23:25:20.000000 shil-2023.7.18.23.25/src/shil.egg-info/top_level.txt
```

### Comparing `shil-2023.7.18.23.21/PKG-INFO` & `shil-2023.7.18.23.25/PKG-INFO`
...
+Metadata-Version: 2.1 Name: shil Version: 2023.7.18.23.25 Summary: Shell helper
...
-               badge.svg]
+               [https://img.shields.io/pypi/l/shil.svg] [https://badge.fury.io/
+               py/shil.svg] [https://github.com/elo-enterprises/shil/actions/
+               workflows/python-test.yml/badge.svg]
 -------------------------------------------------------------------------------
...
### Comparing `shil-2023.7.18.23.21/README.md` & `shil-2023.7.18.23.25/README.md`
...
### Comparing `shil-2023.7.18.23.21/setup.cfg` & `shil-2023.7.18.23.25/setup.cfg`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/setup.py` & `shil-2023.7.18.23.25/setup.py`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/src/shil/__main__.py` & `shil-2023.7.18.23.25/src/shil/__main__.py`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/src/shil/models/__init__.py` & `shil-2023.7.18.23.25/src/shil/models/__init__.py`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/src/shil/parser/__init__.py` & `shil-2023.7.18.23.25/src/shil/parser/__init__.py`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/src/shil/parser/grammar.py` & `shil-2023.7.18.23.25/src/shil/parser/grammar.py`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/src/shil/parser/semantics.py` & `shil-2023.7.18.23.25/src/shil/parser/semantics.py`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/src/shil/util.py` & `shil-2023.7.18.23.25/src/shil/util.py`

 * *Files identical despite different names*

### Comparing `shil-2023.7.18.23.21/src/shil.egg-info/PKG-INFO` & `shil-2023.7.18.23.25/src/shil.egg-info/PKG-INFO`
